...
const campaigns = [
  ...
  },
  {
    ...
    description:
      "A simple CLI app for managing a company's employees using node, inquirer, and MySQL. This application allows a user to add & view departments, roles, and employees. It can also update employee roles.",
  },
];
